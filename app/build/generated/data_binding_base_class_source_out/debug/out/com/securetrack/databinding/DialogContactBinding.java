...
public final class DialogContactBinding implements ViewBinding {
  ...
  private DialogContactBinding(@NonNull LinearLayout rootView, @NonNull TextInputEditText editName,
      @NonNull TextInputEditText editPhone) {
  ...
  public static DialogContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogContactBinding((LinearLayout) rootView, editName, editPhone);
    }
