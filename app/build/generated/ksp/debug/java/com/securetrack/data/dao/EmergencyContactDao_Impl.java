...
public final class EmergencyContactDao_Impl implements EmergencyContactDao {
  ...
  public EmergencyContactDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfEmergencyContact = new EntityInsertionAdapter<EmergencyContact>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `emergency_contacts` (`id`,`name`,`phoneNumber`,`isPrimary`,`createdAt`,`updatedAt`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfEmergencyContact = new EntityDeletionOrUpdateAdapter<EmergencyContact>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `emergency_contacts` SET `id` = ?,`name` = ?,`phoneNumber` = ?,`isPrimary` = ?,`createdAt` = ?,`updatedAt` = ? WHERE `id` = ?";
      }
      ...
      public List<EmergencyContact> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new EmergencyContact(_tmpId,_tmpName,_tmpPhoneNumber,_tmpIsPrimary,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public List<EmergencyContact> getAllContactsSync() {
    final String _sql = "SELECT * FROM emergency_contacts ORDER BY isPrimary DESC, name ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
  ...
  @Override
  public Object getPrimaryContact(final Continuation<? super EmergencyContact> $completion) {
      ...
      public EmergencyContact call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            _result = new EmergencyContact(_tmpId,_tmpName,_tmpPhoneNumber,_tmpIsPrimary,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
